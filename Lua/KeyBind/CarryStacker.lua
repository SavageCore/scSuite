if tweak_data and tweak_data.SCSuiteConfiguration.carry_stacker_toggle then
    ...
    if _toggleCarry then
        managers.chat:_receive_message(1, "scSuite", tweak_data.SCSuiteConfiguration.localization_strings["carry_stacker_toggle_true"], tweak_data.system_chat_color)
        if not CarryStackerSetupDone then
            ...
            if managers and managers.player and IntimitateInteractionExt and CarryInteractionExt then
                managers.player.carry_limit = tweak_data.SCSuiteConfiguration.carry_stacker_limit_value
        ...
        if not managers.player:is_carrying() then managers.player:carry_stacker() end
        managers.player:drop_carry()
        managers.chat:_receive_message(1, "scSuite", tweak_data.SCSuiteConfiguration.localization_strings["carry_stacker_toggle_false"], tweak_data.system_chat_color)
    end
end    