if tweak_data and tweak_data.SCSuiteConfiguration.instant_drill_override_enable then
    if inGame() and isPlaying() and isHost() then
        ...
        -- Chat Message
        managers.chat:_receive_message(1, "scSuite", tweak_data.SCSuiteLocalisation.instant_drill_override_toggle_on, tweak_data.system_chat_color)
        ...
        -- Chat Message        
        managers.chat:_receive_message(1, "scSuite", tweak_data.SCSuiteLocalisation.instant_drill_override_toggle_off, tweak_data.system_chat_color)
        end 
    end  
else
